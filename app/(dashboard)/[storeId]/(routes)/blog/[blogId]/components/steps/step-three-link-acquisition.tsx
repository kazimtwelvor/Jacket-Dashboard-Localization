...
interface StepThreeLinkAcquisitionProps {
  title: string
  subtitle: string
  content: string[]
  image?: string
...
export const StepThreeLinkAcquisition = ({
  title,
  subtitle,
  content,
  image,
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in">
      <div className="rounded-lg p-6 flex items-center justify-center border border-gray-200">
        <EditableImage
          ...
          value={image || "/link-acquisition.png"}
          onSave={onSaveImage ? onSaveImage : () => {}}
          alt="Link Acquisition"
      ...
      <div className="flex flex-col">
        <div className="border-l-4 border-[#FF6C1A] pl-4 mb-4">
          ...
          <p className="text-gray-700 font-medium">Link building services</p>
        </div>
      </div>
    </div>
  )
