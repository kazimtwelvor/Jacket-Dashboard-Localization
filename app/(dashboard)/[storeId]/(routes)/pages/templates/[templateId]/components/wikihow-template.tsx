...
// import { WikihowTemplate } from "../../templates/[templateId]/components/wikihow-template"
...
//         { type: "wikihow-template", icon: <HelpCircle size={24} />, label: "Wikihow Template" },
//       ],
//     },
//   ]
...
//       case "faq-section":
//         return "Frequently Asked Questions"
//       case "wikihow-template":
//         return "Wikihow Template"
//       default:
//         return ""
//     }
//   }
...
//   const getDefaultWikihowTemplateData = () => ({
//     title: "How to Write a Good Blog Post: Complete Guide",
//     authorName: "Ryan Corrigan",
//     authorTitle: "Social Media Expert",
//     reviewDate: "March 29, 2023",
//     viewCount: "1,234,567",
//     helpfulPercentage: "87%",
//     introduction:
//       "A blog post is a piece of writing that appears on a website audience. Before you begin writing your blog post, you should have a clear understanding of your target audience. If you're writing for your own blog, you probably already know your audience. If you're guest blogging, you'll want to make sure your post aligns with the site's usual content.",
//     parts: [
//       {
//         id: "part1",
//         title: "Finding Your Style",
...
//     } else if (type === "wikihow-template") {
//       newElement.wikihowTemplateData = getDefaultWikihowTemplateData()
//     }
...
//             <WikihowTemplate
//               isEditing={false}
//               title={element.wikihowTemplateData?.title}
//               authorName={element.wikihowTemplateData?.authorName}
//               authorTitle={element.wikihowTemplateData?.authorTitle}
//               reviewDate={element.wikihowTemplateData?.reviewDate}
//               viewCount={element.wikihowTemplateData?.viewCount}
//               helpfulPercentage={element.wikihowTemplateData?.helpfulPercentage}
//               introduction={element.wikihowTemplateData?.introduction}
//               parts={element.wikihowTemplateData?.parts || []}
//               onPartsChange={(newParts) => {
//                 updateElement(element.id, {
//                   wikihowTemplateData: { ...element.wikihowTemplateData, parts: newParts },
//                 });
//               }}
//             />
//           </div>
...
//         {/* WikihowTemplate Properties */}
//         {element.type === "wikihow-template" && (
//           <div className="border-t pt-4 mt-4">
//             <h3 className="font-medium text-sm mb-3">Wikihow Article Properties</h3>
//             <div className="space-y-3">
//               <div>
//                 <label className="block text-xs text-gray-600">Article Title</label>
//                 <input
//                   type="text"
//                   value={element.wikihowTemplateData?.title || ""}
//                   onChange={(e) =>
//                     updateElement(element.id, {
//                       wikihowTemplateData: { ...element.wikihowTemplateData, title: e.target.value },
//                     })
//                   }
//                   className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                 />
...
//                   <input
//                     type="text"
//                     value={element.wikihowTemplateData?.authorName || ""}
//                     onChange={(e) =>
//                       updateElement(element.id, {
//                         wikihowTemplateData: { ...element.wikihowTemplateData, authorName: e.target.value },
//                       })
//                     }
//                     className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-xs text-gray-600">Author Title</label>
//                   <input
//                     type="text"
//                     value={element.wikihowTemplateData?.authorTitle || ""}
//                     onChange={(e) =>
//                       updateElement(element.id, {
//                         wikihowTemplateData: { ...element.wikihowTemplateData, authorTitle: e.target.value },
//                       })
//                     }
//                     className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                   />
...
//                 <div>
//                   <label className="block text-xs text-gray-600">Review Date</label>
//                   <input
//                     type="text"
//                     value={element.wikihowTemplateData?.reviewDate || ""}
//                     onChange={(e) =>
//                       updateElement(element.id, {
//                         wikihowTemplateData: { ...element.wikihowTemplateData, reviewDate: e.target.value },
//                       })
//                     }
//                     className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-xs text-gray-600">View Count</label>
//                   <input
//                     type="text"
//                     value={element.wikihowTemplateData?.viewCount || ""}
//                     onChange={(e) =>
//                       updateElement(element.id, {
//                         wikihowTemplateData: { ...element.wikihowTemplateData, viewCount: e.target.value },
//                       })
//                     }
//                     className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-xs text-gray-600">Helpful %</label>
//                   <input
//                     type="text"
//                     value={element.wikihowTemplateData?.helpfulPercentage || ""}
//                     onChange={(e) =>
//                       updateElement(element.id, {
//                         wikihowTemplateData: { ...element.wikihowTemplateData, helpfulPercentage: e.target.value },
//                       })
//                     }
//                     className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
//                   />
...
//               <div>
//                 <label className="block text-xs text-gray-600">Introduction</label>
//                 <textarea
//                   value={element.wikihowTemplateData?.introduction || ""}
//                   onChange={(e) =>
//                     updateElement(element.id, {
//                       wikihowTemplateData: { ...element.wikihowTemplateData, introduction: e.target.value },
//                     })
//                   }
//                   rows={3}
//                   className="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
...
//               {/* Parts and Steps */}
//               <div className="border-t border-gray-200 pt-2">
//                 <h4 className="text-xs font-medium text-gray-700 mb-2">Parts and Steps</h4>

//                 {element.wikihowTemplateData?.parts?.map((part, partIndex) => (
//                   <div key={part.id} className="border p-3 rounded mb-3">
//                     <div className="flex justify-between items-center mb-2">
//                       <h5 className="text-xs font-medium text-gray-700">Part {partIndex + 1}</h5>
//                       <Button
//                         variant="outline"
//                         size="sm"
//                         className="h-6 text-red-500 border-red-500"
//                         onClick={() => {
//                           const newParts = [...(element.wikihowTemplateData?.parts || [])];
...
//                     <div className="mb-2">
//                       <label className="block text-xs text-gray-600">Part Title</label>
//                       <input
//                         type="text"
//                         value={part.title}
//                         onChange={(e) => {
//                           const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                           newParts[partIndex] = { ...newParts[partIndex], title: e.target.value };
//                           updateElement(element.id, {
//                             wikihowTemplateData: { ...element.wikihowTemplateData, parts: newParts },
//                           });
//                         }}
...
//                     {/* Steps */}
//                     {part.steps.map((step, stepIndex) => (
//                       <div key={step.id} className="border p-2 rounded mb-2 bg-gray-50">
//                         <div className="flex justify-between items-center mb-1">
//                           <h6 className="text-xs font-medium text-gray-700">Step {stepIndex + 1}</h6>
//                           <Button
//                             variant="ghost"
//                             size="sm"
//                             className="h-5 text-red-500 p-0"
//                             onClick={() => {
//                               const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                               const newSteps = [...newParts[partIndex].steps];
//                               newSteps.splice(stepIndex, 1);
//                               newParts[partIndex] = { ...newParts[partIndex], steps: newSteps };
//                               updateElement(element.id, {
//                                 wikihowTemplateData: { ...element.wikihowTemplateData, parts: newParts },
//                               });
//                             }}
...
//                             onChange={(e) => {
//                               const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                               newParts[partIndex].steps[stepIndex] = {
//                                 ...newParts[partIndex].steps[stepIndex],
...
//                         <div className="mb-1">
//                           <label className="block text-xs text-gray-600">Step Content</label>
//                           <textarea
//                             value={step.content}
//                             onChange={(e) => {
//                               const newParts = [...(element.wikihowTemplateData?.parts || [])];
...
//                             <label className="block text-xs text-gray-600">Tips</label>
//                             <Button
//                               variant="ghost"
//                               size="sm"
//                               className="h-5 text-blue-500 p-0"
//                               onClick={() => {
//                                 const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                                 const newTips = [...newParts[partIndex].steps[stepIndex].tips, "New tip"];
//                                 newParts[partIndex].steps[stepIndex] = {
//                                   ...newParts[partIndex].steps[stepIndex],
//                                   tips: newTips
//                                 };
...
//                           {step.tips.map((tip, tipIndex) => (
//                             <div key={tipIndex} className="flex items-center mt-1">
//                               <input
//                                 type="text"
//                                 value={tip}
//                                 onChange={(e) => {
//                                   const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                                   const newTips = [...newParts[partIndex].steps[stepIndex].tips];
...
//                                   });
//                                 }}
//                                 className="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs"
//                               />
//                               <Button
//                                 variant="ghost"
//                                 size="sm"
//                                 className="h-5 text-red-500 p-0 ml-1"
//                                 onClick={() => {
//                                   const newParts = [...(element.wikihowTemplateData?.parts || [])];
//                                   const newTips = [...newParts[partIndex].steps[stepIndex].tips];
...
//                           title: `New Step`,
//                           content: "Add your step content here",
//                           tips: ["Add your tip here"]
//                         };
//                         newParts[partIndex].steps.push(newStep);
//                         updateElement(element.id, {
//                           wikihowTemplateData: { ...element.wikihowTemplateData, parts: newParts },
//                         });
//                       }}
