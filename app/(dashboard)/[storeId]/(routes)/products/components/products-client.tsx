...
//   const [quickEditProduct, setQuickEditProduct] = useState<ProductColumn | null>(null)
//   const [filterOpen, setFilterOpen] = useState(false)
//   const [urlUpdated, setUrlUpdated] = useState(false)

//   // Update URL when filters change - with safeguards to prevent infinite loops
//   useEffect(() => {
//     if (urlUpdated) return // Skip if we just updated from URL
...
//     window.open(`/preview/${storeId}/products/${productId}`, "_blank")
//   }
...
//     try {
//       // When setting a product to draft, explicitly set isArchived to false
...
export const ProductsClient: React.FC<ProductsClientProps> = ({
  ...
  const onPreview = (productId: string) => {
    ...
    // Log environment variable and state for debugging
